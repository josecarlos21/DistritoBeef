                    ...
                    <div className="space-y-3">
                        {notifs.map((n, i) => (
                            <button
                                ...
                                className="w-full text-left p-4 rounded-2xl bg-white/5 border border-white/5 hover:bg-white/10 active:scale-[0.98] transition flex gap-4 animate-in slide-in-from-top-4"
