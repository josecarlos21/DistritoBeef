                    ...
                    <div className="px-6 relative -mt-12 flex flex-col items-center text-center">
                        ...
                        <div className="mt-4">
                            ...
                            <div className="flex items-center justify-center gap-1.5 mt-1 text-s">
                                <MapPin size={12} />
                                <span className="text-xs font-bold uppercase tracking-wide">A {user.dist} de ti</span>
                            </div>
                        </div>

                        {/* Actions */}
                        <div className="grid grid-cols-2 gap-3 w-full mt-6 mb-6">
                            <button type="button" onClick={() => triggerHaptic('medium')} className="h-12 rounded-xl bg-white text-black font-black uppercase tracking-wider text-[10px] flex items-center justify-center gap-2 hover:scale-[1.02] active:scale-95 transition">
                                <UserPlus size={16} strokeWidth={2.5} />
                                Conectar
                            </button>
                            <button type="button" onClick={() => triggerHaptic('medium')} className="h-12 rounded-xl border border-white/20 bg-white/5 text-white font-black uppercase tracking-wider text-[10px] flex items-center justify-center gap-2 hover:bg-white/10 active:scale-95 transition">
                        ...
                        <div className="w-full text-left space-y-4 mb-6">
                            <div>
                                <div className="text-[9px] font-black uppercase tracking-[.2em] text-f mb-2">Intereses</div>
                                <div className="flex flex-wrap gap-2">
                                    {tags.map(t => (
                                        <span key={t} className="px-3 py-1 rounded-lg bg-white/5 border border-white/10 text-[10px] font-bold text-m">
                                            {t}
                                        </span>
                                    ))}
                                </div>
                            ...
                            <div>
                                <div className="text-[9px] font-black uppercase tracking-[.2em] text-f mb-2">Última vez visto</div>
                                <div className="flex items-center gap-2 p-3 rounded-xl bg-white/[0.03] border border-white/5">
                                    ...
                                    <div>
                                        ...
                                        <div className="text-[9px] text-f">Hace 15 minutos</div>
                                    </div>
                                </div>
                            </div>
                        </div>
