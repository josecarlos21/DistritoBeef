            ...
            <div className="flex flex-col h-full bg-deep text-white">
                <div className="p-6 pb-2 flex items-center gap-4">
                    ...
                    <div>
                        ...
                        <button onClick={() => setShowPlanner(true)} className="mt-3 px-3 py-1 rounded bg-primary-500 hover:bg-primary-400 text-sm font-bold uppercase tracking-wider shadow-lg shadow-orange-500/20">Crear Itinerario</button>
                    </div>
                </div>
