...
import { Award, RefreshCw, ShieldCheck, HelpCircle, SlidersHorizontal, Info } from 'lucide-react';
  ...
  return (
    <div className="h-full relative font-sans">
      <UnifiedHeader 
        ...
        center={<HeaderTitle title="ID Digital" />}
        right={
      ...
      <div className="pt-28 pb-24 flex flex-col items-center justify-center h-full animate-in fade-in zoom-in-95 duration-500 overflow-y-auto no-scrollbar">
        ...
        <div className="w-full max-w-sm relative group px-4">
          ...
          <GlassContainer strong className="p-8 relative overflow-hidden">
              ...
              <div className="flex justify-between items-start mb-8">
                  <div>
                      <div className="text-[11px] font-black uppercase tracking-[.22em] text-[var(--s)]">Comunidad</div>
                      <div className="text-[10px] font-bold uppercase tracking-wider opacity-60 mt-1 text-white">ID de Usuario</div>
                  </div>
              ...
              >
                  ...
                  <span className="text-[10px] font-black uppercase tracking-widest text-white">Actualizar ID</span>
              </button>

              <div className="flex items-center justify-between pt-6 border-t border-white/10">
                  <div className="text-center">
                      <div className="text-[9px] font-bold text-[var(--f)] uppercase mb-1">Status</div>
                      <div className="text-xs font-black text-white">ACTIVO</div>
                  </div>
                  <div className="text-center">
                      <div className="text-[9px] font-bold text-[var(--f)] uppercase mb-1">Membresía</div>
                      <div className="text-xs font-black text-white">2026</div>
                  </div>
                  <div className="text-center">
        ...
        <div className="mt-8 text-center px-8 flex flex-col items-center gap-3">
          <div className="flex items-start gap-2 text-left bg-white/5 p-3 rounded-xl border border-white/5">
             <Info size={16} className="text-[var(--f)] shrink-0 mt-0.5" />
             <p className="text-[10px] font-medium leading-relaxed text-[var(--f)]">
                  Este código QR es tu identidad digital dentro de la app District Vallarta. 
                  <strong className="text-white block mt-1">No es válido como boleto de entrada para eventos de terceros.</strong>
             </p>
          </div>
