...
const messages: Messages = {
  es: {
    ...
    'action.addToAgenda': 'Agregar a mi agenda',
    'action.addedToAgenda': 'En mi agenda',
    ...
    'home.party': 'Party Time',
    'header.explore': 'Explorar',
    'header.itinerary': 'Itinerario',
    'header.agenda': 'Agenda 2026',
    'header.wallet': 'Wallet',
    'header.map': 'Mapa',
    'action.visitWebsite': 'Fuente',
    'action.googleMaps': 'Google Maps',
    'action.share': 'Compartir',
    'action.linkCopied': '¡Enlace copiado!',
    'action.rate': 'Calificar',
    'action.rateSuccess': '¡Gracias por calificar!',
    'action.rateCriteria': 'Solo puedes calificar si estás en el evento ahora.',
    ...
    'checkout.title': 'RSVP',
    'checkout.general': 'Acceso General / General Access',
    'checkout.includes': 'Lista de Invitados / Guestlist',
    'checkout.quantity': 'ASISTENTES',
    'checkout.total': 'ESTIMADO',
    'checkout.pay': 'Confirmar RSVP',
    'checkout.processing': 'Registrando...',
    'checkout.validating': 'Verificando disponibilidad',
    'checkout.success': '¡Confirmado!',
    'checkout.successMsg': 'Tu nombre está en la lista. Nos vemos en el evento.',
    'profile.connect': 'Conectar',
    'profile.message': 'Mensaje',
    'profile.interests': 'Intereses',
    'profile.seen': 'Última vez visto',
    'profile.ago': 'Hace',
    'profile.minutes': 'minutos',
    'profile.distance': 'de ti',
  },
  en: {
    'lang.name': 'English',
    ...
    'action.start': 'Start',
    'action.addToAgenda': 'Add to my agenda',
    'action.addedToAgenda': 'In my agenda',
    'action.next': 'Next',
    ...
    'header.wallet': 'Wallet',
    'header.map': 'Map',
    'action.visitWebsite': 'Source',
    'action.googleMaps': 'Google Maps',
    'action.share': 'Share',
    'action.linkCopied': 'Link copied!',
    'action.rate': 'Rate',
    'action.rateSuccess': 'Thanks for rating!',
    'action.rateCriteria': 'You can only rate if you are at the event now.',
    ...
    'checkout.title': 'RSVP',
    'checkout.general': 'General Access',
    'checkout.includes': 'Guestlist Entry',
    'checkout.quantity': 'GUESTS',
    'checkout.total': 'ESTIMATED',
    'checkout.pay': 'Confirm RSVP',
    'checkout.processing': 'Registering...',
    'checkout.validating': 'Checking availability',
    'checkout.success': 'Confirmed!',
    'checkout.successMsg': 'Your name is on the list. See you at the event.',
    'profile.connect': 'Connect',
    'profile.message': 'Message',
    'profile.interests': 'Interests',
    'profile.seen': 'Last seen',
    'profile.ago': 'Ago',
